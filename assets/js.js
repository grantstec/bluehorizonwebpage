var colors = new Array([38, 116, 182],[6, 2, 112],[0, 102, 255],[0, 153, 255],[0, 0, 153],[51, 204, 255],[0, 0, 204]);
...
$(document).ready(function() {
    ...
    if (parameter("s") == "y") {
        ...
        setTimeout(function() {
            $("#contact-bin").css("margin-bottom", "-40px").fadeOut(300)
        }, 2000);
    }
    ...
    if (localStorage.getItem("colorIndices") == null)
...
$(".wrapper, .contact").hover(function() {
    $("body").removeClass("menu-open")
}, function() {});
